<?php // Do not delete these lines
	...
	/* This variable is for alternating comment background. Not utilised in these theme, but could be */
...
<label for="email">Email (will not be published<?php if ($req) echo ", required"; ?>, gravatar-enabled)</label></p>
